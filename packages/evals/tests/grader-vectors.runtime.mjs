/**
 * Canonical vectors for deterministic text, similarity, context, and PII
 * graders. Vector shape: {name, type, candidate, options, expected_passed}, plus
 * expected_score or expected_pii when applicable.
 */
...
const vectors = JSON.parse(readFileSync(join(here, "grader-vectors.json"), "utf8"));
