...
// Budget includes worker startup and scheduling, not only RegExp.test(). 100ms
// produced false deadline failures under normal parallel Go/Python/Node gates;
// 250ms remains below the public 500ms prompt-settlement contract while keeping
// catastrophic patterns isolated and forcibly terminated.
