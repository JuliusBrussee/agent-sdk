# `@caveman-ai/agent` API reference
...
Profile-guided compiler and build system for portable, eval-gated production agents.

Each entrypoint has its own page.
...
| `@caveman-ai/agent/claude` | `packages/agent/dist/claude.d.ts` | 2 | [claude.md](claude.md) |
| `@caveman-ai/agent/code` | `packages/agent/dist/code.d.ts` | 57 | [code.md](code.md) |
| `@caveman-ai/agent/command-session` | `packages/agent/dist/command-session.d.ts` | 12 | [command-session.md](command-session.md) |
| `@caveman-ai/agent/execution-backend` | `packages/agent/dist/execution-backend.d.ts` | 5 | [execution-backend.md](execution-backend.md) |
| `@caveman-ai/agent/testing` | `packages/agent/dist/testing.d.ts` | 4 | [testing.md](testing.md) |
| `@caveman-ai/agent/catalog` | `packages/agent/dist/catalog.d.ts` | 21 | [catalog.md](catalog.md) |
...
| `@caveman-ai/agent/wire` | `packages/agent/dist/wire.d.ts` | 6 | [wire.md](wire.md) |
